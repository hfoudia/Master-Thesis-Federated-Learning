    ...
    for client in clients:
        if input_shape != client['input_shape'] or \
            ...
            max_flow_len != client['max_flow_len']:
                ...
                # print("Client ", client['name'], " properties: ", "client input_shape : ", client['input_shape'], ", client features : ", client['features'], ", client classes : ", client['classes'], ", client time_window : ", client['time_window'], ", client max_flow_len : ", client['max_flow_len'], "\n")
                # print("Comparison client properties: ", "client input_shape : ", input_shape, ", client features : ", features, ", client classes : ", classes, ", client time_window : ", time_window, ", client max_flow_len : ", max_flow_len, "\n")
                return False
    return True